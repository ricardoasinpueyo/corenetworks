...
emp114 = new Empleado(114, "diego", "martinez", null, 30_000, 45,0,  dep30);
emp115 = new Empleado(115, "sara", "perez", null, 20_000, 27,0, dep30);
emp116 = new Empleado(116, "carlos", "sanchez", null, 10_000, 30,0, dep30);
emp300 = new Empleado(300, "natalia", "vazquez",null, 60_000, 28,0, dep30);
 ...
 * un emp225 que se llama Carmen Gonzalez que gana 70_000 y que pertenece al dep30*/
 ...
 Departamento dep120 = new Departamento(120,"Formación", new Empleado(225, "Carmen", "González", null, 70_000, 32, 0,dep30));
